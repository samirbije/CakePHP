...
class Settings extends Admin_Controller
{
	...
	function index()
	{
		...
		$config['group'] = array(
                ...
                'general'     => array('name'=> $this->lang->line('preference_page_general_configuration'), 'fields'=>'site_name,date_default_timezone'),
				...
				'ercs_settings' => array('name'=> $this->lang->line('preference_page_ercs_settings'), 'fields'=>'allow_ip_list'),	
		);
