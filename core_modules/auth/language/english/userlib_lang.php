...
$lang['userlib_create_user'] = "Create User";
$lang['userlib_edit_user'] = "Modify User";
$lang['userlib_delete_user'] = "Delete User";
$lang['userlib_administrator_delete'] = "You cannot delete the main Administrator user account.";
$lang['userlib_user_saved'] = "The users '%s' has been saved successfully";
$lang['userlib_user_deleted'] = "The users have been deleted successfully";
...
$lang['userlib_password_info'] = "If you are modifying a current user account, you do not need to enter the password fields unless you want to change their password.";
$lang['userlib_delete_user_confirm'] = "Are you SURE you want to delete these users? Doing so could loose system data!";
...
$lang['userlib_validation_vlan'] = 'The %s is already in use.';
$lang['userlib_validation_ipaddress'] = 'The %s is already in use.';
...
$lang['userlib_invalid_user_id'] = "Invalid User ID: '%s'. Redirected to User List Page";

/* End of file userlib_lang.php */
/* Location: ./core_modules/auth/language/english/userlib_lang.php */