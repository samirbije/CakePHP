	...
	<section class="content">
		...
		<div class="row">
			<div class="col-xs-12 connectedSortable">
				...
				<button type="button" class="btn btn-success btn-flat btn-xs" id="jqxGridUsersCreate" onClick="location.href='<?php echo site_url('admin/advertise/banner_form');?>'"><?php echo lang('create'); ?></button>
...
$(function(){	
	var smartpitDataSource =
	{
		...
		url: '<?php echo site_url('admin/advertise/banner_json')?>',
	...
	$("#jqxGridPopup").jqxGrid({
		...
		columns: [
			...
			{ text: 'Location Name',	datafield: 'location_name', 	width: 150, filterable: true, renderer: gridColumnsRenderer},
				{ text: 'Images', 			datafield: 'image', 			width: 150, filterable: true,  renderer: gridColumnsRenderer},
				{ text: 'Device Name', 			datafield: 'device_name', 			width: 150, filterable: true,  renderer: gridColumnsRenderer},
					{ text: 'Contents', 			datafield: 'text', 			width: 150, filterable: true,  renderer: gridColumnsRenderer},
...
function editRecord(index){
    ...
    window.location = '<?php echo site_url("admin/advertise/bannerform");?>' + '/' + datarow.id;
}
function deleteRecord(index){
	...
	var datarow = $("#jqxGridPopup").jqxGrid('getrowdata', index);
		$.ajax({
        type: "POST",
        url: '<?php echo site_url("admin/advertise/banner_delete")?>/' +  datarow.id,
        cache: false,
